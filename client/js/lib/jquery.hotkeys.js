...
(function (jQuery){
    ...
    var hotkeys = {
        ...
        specialKeys: { 27: 'esc', 9: 'tab', 32:'space', 13: 'return', 8:'backspace', 145: 'scroll', 
            ...
            120:'f9', 121:'f10', 122:'f11', 123:'f12', 191: '/', 219: '[', 221 : ']'},
        // PATCH: 219 and 221 added -- EVAN.S
    ...
    hotkeys.handler = function(event) {
        ...
        if(ids){
            ...
            var code = event.which,
                ...
                // PATCH: Mac bug fix - prevent misfire of '[' key when using CMD key - EVAN.S
    ...
    $.hotkeys = "definedlol"; // PATCH: Bind to $.hotkeys to stop JSTree throwing a hotkeys undefined error
    return jQuery;
})(jQuery);
