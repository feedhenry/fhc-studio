client.studio.editor = {
  ...
  appendTabWithIndex: function(index, title){
    ...
    li.appendChild(a);
    a.innerHTML = title;
    $('.server.editor .editorTabs').append(li); // add the tab element into our UL
    ...
    $('.server.editor .pill-content').append(tabContentEl); // add the tab body into our pill content DOM el
  },
  snippet: function(id){
      var me = client.studio.editor;
